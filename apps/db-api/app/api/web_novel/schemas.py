...
if TYPE_CHECKING:
    from app.models import WebNovel, WebNovelTitle
...
def to_web_novel_title_schema(title: 'WebNovelTitle') -> WebNovelTitleSchema:
...
def to_web_novel_schema(web_novel: 'WebNovel') -> WebNovelSchema:
    return WebNovelSchema(
        web_novel_id=str(web_novel.web_novel_id),
